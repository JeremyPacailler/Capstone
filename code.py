...
f_path = r'C:\Users\Jeremy\Downloads\Capstone\data\Population of all US Cities 2024.csv'
...
# To create a prediction based on any upcoming/abitrary/future city 
# please follow the instructions below

# 1. please input the numbers with any valid numbers for the growth rate, 2020 population, density, and area
# 2. for accurate results, please refer to the describe table at the top of the notebook
# 3. the current numbers are the middle 50% of data
# 4. then please input a prediction year to get your desired population prediction for that year
...
area = 62
ppop = pop2024
# year used to predict population based on 2024 population prediction
